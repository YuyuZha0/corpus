...
@ToString
@Builder
public final class ClassicPoetry implements Serializable {
  ...
  public static ClassicPoetry fromLuceneDocument(@NonNull Document document) throws Exception {
    return new ClassicPoetry(
  ...
  public ClassicPoetry map(@NonNull BiFunction<FieldEnum, String, String> mapper) {
    return new ClassicPoetry(
  ...
  public String getContentIdentifier() {
    ...
    Matcher matcher = CN_PTN.matcher(this.content);

    StringBuilder builder = new StringBuilder(this.content.length());
