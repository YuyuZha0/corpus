package com.github.yuyu.query;

import com.github.yuyu.entity.ClassicPoetry;
import com.github.yuyu.entity.FieldEnum;
...
public final class LuceneFacade {
  ...
  public LuceneFacade(@NonNull String indexPath) {
    this.analyzer = new AnalyzerFactory().get();
  ...
  public List<ClassicPoetry> search(
    ...
    List<ClassicPoetry> result = new ArrayList<>(resultSize);

    for (ScoreDoc scoreDoc : topDocs.scoreDocs) {
      Document document = indexSearcher.doc(scoreDoc.doc);
      ClassicPoetry poetry = ClassicPoetry.fromLuceneDocument(document);
